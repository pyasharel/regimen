...
| `semaglutide` | GLP-1 drug name for discoverability |
| `tirzepatide` | GLP-1 drug name for discoverability |
| `retatrutide` | Emerging GLP-1 compound |
...
### High Intent - Exact Match Campaign Setup

**Configuration:**
- **Daily Budget:** $5.00
- **Default Max CPT Bid:** $2.00
- **Ad Group Name:** Core Keywords - Exact
- **Search Match:** OFF
...
| shot tracker | - | - | - | ❌ Sports/golf dominated |
| hormone tracker | - | - | - | ❌ Period/fertility dominated |
| reconstitution calculator | 40 (Medium) | 46 | 1.16 | 🎯 Best opportunity |
| peptide dose calculator | 36 (Easy) | 32 | 0.90 | ⚠️ Lower priority (traffic) |

### KEI Formula
```
KEI = Traffic² / Difficulty
Higher KEI = Better opportunity
```
...
**BPC-157 + TB-500 Article:**
- Current: 228 impressions, 0% CTR
...
|------|----------------|----------|
| `/calculators/tirzepatide-reconstitution` | tirzepatide calculator | High |
| `/calculators/bpc157-dosage` | bpc157 dose | Medium |
...
1. **In-app review prompt** - Trigger after 7-day streak
2. **Personal outreach** - Beta testers and power users
3. **Reddit engagement** - Value-first, not promotional
4. **Email follow-up** - 7 days after first compound added
...
- Same user intent (people want to track)
- Compounds well with drug names (testosterone log, injection log)

### Why Reconstitution Calculator Is Best Opportunity
- Highest traffic (46) of untapped keywords
- Medium difficulty (40) = achievable
- Calculator is already in subtitle
- Content marketing can boost organic ranking

### Conversion Insights
- TRT/power peptide users convert 3x better than single-compound GLP-1 users
- Focus ASO on high-intent "log" and "protocol" terms
- De-prioritize brand keywords (Ozempic, Mounjaro) - low conversion
